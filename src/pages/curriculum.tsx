...
>(({ className, ...props }, ref) => (
  <article
    ...
    <div className="flex flex-row h-[70vh] mx-9">
      ...
      <section className="group flex-[2] flex flex-col-reverse w-min border border-cyan-900 rounded-r-md h-full hover:transition-all ease-in-out delay-150 duration-500 bg-cyan-800 shadow-cyan-800 shadow-md hover:flex-[3] hover:bg-cyan-100">
        <h3 className="text-center text-cyan-100 italic font-bold mt-3 bg-cyan-800">Notable Skills</h3>

        <div className="@container flex-grow m-4">
          <ul className="hidden @3xs:block list-none text-right my-4 start-0 content-center">
            <li className="mb-0 px-3 transition-colors text-cyan-100 group-hover:text-cyan-800 group-hover:hover:text-cyan-100 hover:bg-cyan-800 after:font-family-awesome after:skill-5">
              <span className="pr-3">Java</span>
            </li>
            <li className="mb-0 px-3 transition-colors text-cyan-100 group-hover:text-cyan-800 group-hover:hover:text-cyan-100 hover:bg-cyan-800 after:font-family-awesome after:skill-3">
              <span className="pr-3">Python</span>
            </li>
            <li className="mb-0 px-3 transition-colors text-cyan-100 group-hover:text-cyan-800 group-hover:hover:text-cyan-100 hover:bg-cyan-800 after:font-family-awesome after:skill-2">
              <span className="pr-3">NodeJS</span>
            </li>
            <li className="mb-0 px-3 transition-colors text-cyan-100 group-hover:text-cyan-800 group-hover:hover:text-cyan-100 hover:bg-cyan-800 after:font-family-awesome after:skill-1">
            ...
            <li className="mb-0 px-3 transition-colors text-cyan-100 group-hover:text-cyan-800 group-hover:hover:text-cyan-100 hover:bg-cyan-800 after:font-family-awesome after:skill-4">
          ...
          <p className="block @3xs:hidden prose prose-sm w-auto max-w-max my-4 text-justify text-cyan-100">
            Specialist: <br />
            - Java;<br />
            - Selenium;<br />
            <br />
      ...
      <section className="flex-[1] flex flex-col-reverse w-min border border-cyan-900 rounded-r-md h-full hover:transition-all ease-in-out delay-150 duration-500 bg-cyan-800 shadow-cyan-800 shadow-md hover:flex-[9] hover:bg-cyan-100">
      ...
      <section className="group flex-[1] flex flex-col-reverse w-min border border-cyan-900 rounded-r-md h-full hover:transition-all ease-in-out delay-150 duration-500 bg-cyan-800 shadow-cyan-800 shadow-md hover:flex-[9] hover:bg-cyan-100">
        ...
        <div className="@container flex-grow my-4 group-hover:m-4">
          <div className="hidden @2xs:block">
            <ul className="m-auto list-none text-left">
              <li className="my-3 px-3 cursor-pointer transition-colors text-cyan-100 group-hover:text-cyan-800 group-hover:hover:text-cyan-100 hover:bg-cyan-800 before:font-family-awesome before:social-website">
                <a className="pl-2" href="https://www.jsperafico.me" target="_blank">https://www.jsperafico.me</a>
              </li>
              <li className="my-3 px-3 cursor-pointer transition-colors text-cyan-100 group-hover:text-cyan-800 group-hover:hover:text-cyan-100 hover:bg-cyan-800 before:font-family-awesome before:social-linkedin">
                <a className="pl-2" href="https://www.linkedin.com/in/jonathanpintosperafico/" target="_blank">jonathanpintosperafico</a>
              </li>
              <li className="my-3 px-3 cursor-pointer transition-colors text-cyan-100 group-hover:text-cyan-800 group-hover:hover:text-cyan-100 hover:bg-cyan-800 before:font-family-awesome before:social-github">
                <a className="pl-2" href="https://github.com/jsperafico" target="_blank">jsperafico</a>
              </li>
              <li className="my-3 px-3 cursor-pointer transition-colors text-cyan-100 group-hover:text-cyan-800 group-hover:hover:text-cyan-100 hover:bg-cyan-800 before:font-family-awesome before:social-mail">
